    ...
    def self.code
      Proc.new do |navigation|
        navigation.items do |primary|
          ...
          primary.item :music_metadata_enrichment_artists, I18n.t('music_artists.index.short_title'), music_metadata_enrichment_artists_path do |programs|
            programs.item :new, I18n.t('general.new'), new_music_metadata_enrichment_artist_path
          end
